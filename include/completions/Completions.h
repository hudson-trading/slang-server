...
static void resolveMacro(const syntax::DefineDirectiveSyntax& macro, lsp::CompletionItem& ret) {
...
static lsp::CompletionItem getMacroCompletion(std::string name) {
...
static lsp::CompletionItem getMacroCompletion(const slang::syntax::DefineDirectiveSyntax& macro,
...
static lsp::CompletionItem getModuleCompletion(std::string name, lsp::SymbolKind kind) {
...
static lsp::CompletionItem getMemberCompletion(const slang::ast::Symbol& symbol) {
...
static void resolveMemberCompletion(const slang::ast::Scope& scope, lsp::CompletionItem& item) {
...
static void getMemberCompletions(std::vector<lsp::CompletionItem>& results,
                                 const slang::ast::Scope* scope, bool isLhs) {
...
static void resolveModule(const slang::syntax::ModuleHeaderSyntax& header, lsp::CompletionItem& ret,
...
static void resolveModule(const slang::syntax::SyntaxTree& tree, std::string_view moduleName,
